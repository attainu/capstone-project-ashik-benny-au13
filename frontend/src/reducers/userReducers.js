...
import { LOGIN_SUCCESS, LOGIN_FAIL, LOGIN_REQUEST, CLEAR_ERRORS,
         REGISTER_USER_SUCCESS, REGISTER_USER_FAIL, REGISTER_USER_REQUEST,
         LOAD_USER_SUCCESS, LOAD_USER_FAIL, LOAD_USER_REQUEST,
    ...
    switch (action.type){
        ...
        case UPDATE_PASSWORD_SUCCESS:
            return{
                ...state,
                loading: false,
                isUpdated: action.payload            //in backend,we will get data from success:true/false
            }
